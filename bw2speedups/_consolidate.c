...
/* "bw2speedups/_consolidate.pyx":9
 * 
 * ctypedef np.int64_t TTYPE_t
 * ctypedef np.float64_t VTYPE_t             # <<<<<<<<<<<<<<
 * 
...
/* "bw2speedups/_consolidate.pyx":17
 * 
...
static PyObject *__pyx_pf_11bw2speedups_12_consolidate_consolidate(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a, PyArrayObject *__pyx_v_b) {
  ...
  __pyx_pybuffernd_b.rcbuffer = &__pyx_pybuffer_b;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_nn___pyx_t_11bw2speedups_12_consolidate_TTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_b.rcbuffer->pybuffer, (PyObject*)__pyx_v_b, &__Pyx_TypeInfo_nn___pyx_t_11bw2speedups_12_consolidate_VTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
  }
  ...
  /* "bw2speedups/_consolidate.pyx":44
 ...
 */
  ...
  /* "bw2speedups/_consolidate.pyx":45
 *     #it works with view so `times.view('int64')` has to be passed to consolidate instead of `times`
 *     assert a.shape[0] == b.shape[0]
 *     index_values = np.unique(a)             # <<<<<<<<<<<<<<
 *     index_values.sort()
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_TTYPE); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 49, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_new_shape); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_VTYPE); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_range_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_new_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = NULL;
  ...
  if (likely(PyList_CheckExact(__pyx_t_1)) || PyTuple_CheckExact(__pyx_t_1)) {
    ...
    __pyx_t_8 = -1; __pyx_t_5 = PyObject_GetIter(__pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 53, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_9 = Py_TYPE(__pyx_t_5)->tp_iternext; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 53, __pyx_L1_error)
  }
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  for (;;) {
    if (likely(!__pyx_t_9)) {
      if (likely(PyList_CheckExact(__pyx_t_5))) {
        ...
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_1 = PyTuple_GET_ITEM(__pyx_t_5, __pyx_t_8); __Pyx_INCREF(__pyx_t_1); __pyx_t_8++; if (unlikely(0 < 0)) __PYX_ERR(0, 53, __pyx_L1_error)
        #else
        __pyx_t_1 = PySequence_ITEM(__pyx_t_5, __pyx_t_8); __pyx_t_8++; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 53, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        #endif
    ...
    /* "bw2speedups/_consolidate.pyx":54
 * 
 *     for index in _range(new_shape):
 *         c[index] = index_values[index]             # <<<<<<<<<<<<<<
 *         d[index] = b.take(np.where(a == index_values[index])).sum()
 ...
 */
    __pyx_t_1 = __Pyx_PyObject_GetItem(__pyx_v_index_values, __pyx_v_index); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_b), __pyx_n_s_take); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_11 = __Pyx_PyObject_GetItem(__pyx_v_index_values, __pyx_v_index); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_sum); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = NULL;
    if (CYTHON_UNPACK_METHODS && likely(PyMethod_Check(__pyx_t_3))) {
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_c), __pyx_n_s_view); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = NULL;
  ...
  __pyx_t_5 = (__pyx_t_3) ? __Pyx_PyObject_Call2Args(__pyx_t_1, __pyx_t_3, __pyx_kp_s_timedelta64_s) : __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_kp_s_timedelta64_s);
  __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *     """Consolidate an index array and values array, summing elements in the values array for each unique element of the index array.
 */
  __pyx_tuple__8 = PyTuple_Pack(7, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_index_values, __pyx_n_s_new_shape, __pyx_n_s_c, __pyx_n_s_d, __pyx_n_s_index); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(2, 0, 7, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_bw2speedups__consolidate_pyx, __pyx_n_s_consolidate, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 */
  ...
  /* "bw2speedups/_consolidate.pyx":5
 * cimport cython
 * 
 * TTYPE= np.int64             # <<<<<<<<<<<<<<
 * VTYPE = np.float64
 ...
 */
  ...
  /* "bw2speedups/_consolidate.pyx":6
 * 
 * TTYPE= np.int64
 * VTYPE = np.float64             # <<<<<<<<<<<<<<
 * 
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "bw2speedups/_consolidate.pyx":12
 * 
 * try:
 *     _range = xrange             # <<<<<<<<<<<<<<
 * except NameError:
 ...
 *     """Consolidate an index array and values array, summing elements in the values array for each unique element of the index array.
 */
  __pyx_t_7 = PyCFunction_NewEx(&__pyx_mdef_11bw2speedups_12_consolidate_1consolidate, NULL, __pyx_n_s_bw2speedups__consolidate); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
