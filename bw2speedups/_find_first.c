/* Generated by Cython 0.20.2 on Sat Aug  2 00:42:40 2014 */
...
static PyMethodDef __pyx_mdef_11bw2speedups_11_find_first_1find_first = {__Pyx_NAMESTR("find_first"), (PyCFunction)__pyx_pw_11bw2speedups_11_find_first_1find_first, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_11bw2speedups_11_find_first_find_first)};
static PyObject *__pyx_pw_11bw2speedups_11_find_first_1find_first(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("find_first", 1, 2, 2, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "find_first") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  __Pyx_RaiseArgtupleInvalid("find_first", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_11bw2speedups_11_find_first_find_first(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a, PyObject *__pyx_v_b) {
  ...
  __pyx_pybuffernd_a.rcbuffer = &__pyx_pybuffer_a;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_nn___pyx_t_11bw2speedups_11_find_first_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_As_npy_uint8(__pyx_v_b); if (unlikely((__pyx_t_1 == (npy_uint8)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  /* "bw2speedups/_find_first.pyx":18
 *     cdef DTYPE_t value = b
 *     cdef int a_max = a.shape[0]
 *     for x in xrange(a_max):             # <<<<<<<<<<<<<<
 *         if a[x] == value:
 *             return x
 */
  __pyx_t_2 = __pyx_v_a_max;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_x = __pyx_t_3;

    /* "bw2speedups/_find_first.pyx":19
 *     cdef int a_max = a.shape[0]
 *     for x in xrange(a_max):
 *         if a[x] == value:             # <<<<<<<<<<<<<<
 *             return x
 ...
 */
    ...
    __pyx_t_5 = (((*__Pyx_BufPtrStrided1d(__pyx_t_11bw2speedups_11_find_first_DTYPE_t *, __pyx_pybuffernd_a.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_a.diminfo[0].strides)) == __pyx_v_value) != 0);
    if (__pyx_t_5) {

      /* "bw2speedups/_find_first.pyx":20
 *     for x in xrange(a_max):
 *         if a[x] == value:
 *             return x             # <<<<<<<<<<<<<<
 *     return False
 */
      ...
      __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  __pyx_tuple__7 = PyTuple_Pack(5, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_value, __pyx_n_s_a_max, __pyx_n_s_x); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_find_first"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 * 
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_11bw2speedups_11_find_first_1find_first, NULL, __pyx_n_s_bw2speedups__find_first); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_find_first, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
